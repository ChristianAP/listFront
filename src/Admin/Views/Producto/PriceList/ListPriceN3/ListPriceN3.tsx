...
export const ListPriceN3 = () => {
       // ? QUERY PARA OBTENER LA DATA DEL BACKEND
       const { isLoading, isError, data, error, isFetching, refetch } = useQuery(['PriceList', 3], () => getPriceList(3), { refetchOnWindowFocus: false })
           ...
           <>
               ...
               <MyContain>
                   <HStack>
                       <Flex>
                           <Box>
                               <DescargarPriceList level={'3'}/>
                               <ImportPriceList level={'3'} setCarganding = {setCarganding}/>
                           </Box>
                       </Flex>
                       <Spacer />
