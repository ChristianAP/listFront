...
export const ListPriceN2 = () => {
       // ? QUERY PARA OBTENER LA DATA DEL BACKEND
       const { isLoading, isError, data, error, isFetching, refetch } = useQuery(['PriceList', 2], () => getPriceList(2), { refetchOnWindowFocus: false })
           ...
           <>
               ...
               <MyContain>
                   <HStack>
                       <Flex>
                           <Box>
                               <DescargarPriceList level={'2'}/>
                               <ImportPriceList level={'2'} setCarganding = {setCarganding}/>
                           </Box>
                       </Flex>
                       <Spacer />
